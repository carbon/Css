...
namespace Carbon.Css
{
    public sealed class CssUnitInfo : IEquatable<CssUnitInfo>
    {
        ...
        public static readonly CssUnitInfo Em   = new CssUnitInfo("em",   NodeKind.Length, CssUnitFlags.Relative); // | font size of the element
        ...
        public static readonly CssUnitInfo Rem  = new CssUnitInfo("rem",  NodeKind.Length, CssUnitFlags.Relative); // | font size of the root element
        ...
        public static readonly CssUnitInfo Vmin = new CssUnitInfo("vmin", NodeKind.Length, CssUnitFlags.Relative); // | 1% of viewport’s smaller dimension
        public static readonly CssUnitInfo Vmax = new CssUnitInfo("vmax", NodeKind.Length, CssUnitFlags.Relative); // | 1% of viewport’s larger dimension
        ...
        public static readonly CssUnitInfo Px = new CssUnitInfo("px", NodeKind.Length); // pixels	                1px = 1/96th of 1in

        // <percentages> | %
        public static readonly CssUnitInfo Percentage = new CssUnitInfo("%", NodeKind.Percentage);

        // <angle> deg, grad, rad, turn
        public static readonly CssUnitInfo Deg  = new CssUnitInfo("deg",  NodeKind.Angle);
        ...
        // <time> | s, ms
        public static readonly CssUnitInfo S    = new CssUnitInfo("s", NodeKind.Time);
        public static readonly CssUnitInfo Ms   = new CssUnitInfo("ms", NodeKind.Time);
        ...
        public static readonly CssUnitInfo X     = new CssUnitInfo("x",    NodeKind.Resolution);
